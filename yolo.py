...
try:
    # This handles the case where getUnconnectedOutLayers() returns an array of indices
    ln = [ln[i[0] - 1] for i in net.getUnconnectedOutLayers()]
except IndexError:
    # This handles the case where getUnconnectedOutLayers() returns a scalar (e.g., 1, 2, 3)
